...
const PASSWORD_REQD = 'Password is required to validate'

export const aesEncryption = Router()
aesEncryption.post('/register', async (req, res) => {
  try {
...
aesEncryption.post('/generateOtp', async (req, res) => {
  try {
